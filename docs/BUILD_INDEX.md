...
3. **V1.5 (Phase 1.5.x)** — make the agent *hear* code-mixed math/science correctly. A quality fix on top of V1.
...
- **Realtime infra:** LiveKit Cloud free tier (not a Maximem credit).
...
- Foundation, V1, V1.5: **no paid credits** (LiveKit free tier + your LLM/STT/TTS keys).
